--CREATE OR REPLACE VIEW vwMiscClinical AS 
SELECT 
...
LEFT JOIN tblshared_stage_tnm_categories
	ON tblshared_stage_stage_event.tblshared_stage_stage_event_id_key=tblshared_stage_tnm_categories.tblshared_stage_stage_event_id_key
LEFT JOIN tblshared_stage_pathologic_categories
	ON tblshared_stage_tnm_categories.tblshared_stage_tnm_categories_id_key=tblshared_stage_pathologic_categories.tblshared_stage_tnm_categories_id_key
LEFT JOIN tblshared_stage_pathologic_m
	ON tblshared_stage_pathologic_categories.tblshared_stage_pathologic_categories_id_key=tblshared_stage_pathologic_m.tblshared_stage_pathologic_categories_id_key
LEFT JOIN tblshared_stage_pathologic_n
	ON tblshared_stage_pathologic_categories.tblshared_stage_pathologic_categories_id_key=tblshared_stage_pathologic_n.tblshared_stage_pathologic_categories_id_key
LEFT JOIN tblshared_stage_pathologic_stage
	ON tblshared_stage_stage_event.tblshared_stage_stage_event_id_key=tblshared_stage_pathologic_stage.tblshared_stage_stage_event_id_key
LEFT JOIN tblshared_stage_pathologic_t
	ON tblshared_stage_pathologic_categories.tblshared_stage_pathologic_categories_id_key=tblshared_stage_pathologic_t.tblshared_stage_pathologic_categories_id_key
LEFT JOIN tblshared_stage_system_version
	ON tblshared_stage_stage_event.tblshared_stage_stage_event_id_key=tblshared_stage_system_version.tblshared_stage_stage_event_id_key
LIMIT 5